...
#include <imgui.h>
	...
	#error Upscaler requires LIGHTD3D12_HAS_AMD_FSR_SDK=1. Verify LightD3D12.FSR.props and the AMD FSR SDK layout.
#endif
...
namespace
{
	...
	void RecreateTargets( AppState& app )
	{
		...
		sceneColorDesc.debugName = "Upscaler Scene Color";
		...
		depthDesc.debugName = "Upscaler Scene Depth";
		...
		motionDesc.debugName = "Upscaler Motion Vectors";
		...
		upscaledOutputDesc.debugName = "Upscaler Output";
...
int WINAPI wWinMain( HINSTANCE instance, HINSTANCE, PWSTR, int showCommand )
{
	try
	{
		...
		windowClass.lpszClassName = L"LightD3D12UpscalerWindow";
		...
		while( app.running )
		{
			...
			{
				LIGHTD3D12_CMD_SCOPE_NAMED( commandBuffer, "Upscaler::ScenePass", 0xff4cc9f0u );
			...
			{
				LIGHTD3D12_CMD_SCOPE_NAMED( commandBuffer, "Upscaler::ImguiPass", 0xfff9844au );
