...
float4 main(float4 position : SV_Position) : SV_Target0
{
	...
	void RecreateSceneDepth( AppState& app )
	{
		...
		depthDesc.debugName = "ShadowMapping Scene Depth";
	...
	void RecreateShadowResources( AppState& app )
	{
		...
		shadowMapDesc.debugName = "ShadowMapping ShadowMap";
		...
		previewDesc.debugName = "ShadowMapping Shadow Preview";
...
int WINAPI wWinMain( HINSTANCE instance, HINSTANCE, PWSTR, int showCommand )
{
	...
	try
	{
		...
		windowClass.lpszClassName = L"LightD3D12ShadowMappingWindow";
		...
		while( app.running )
		{
			...
			{
				LIGHTD3D12_CMD_SCOPE_NAMED( commandBuffer, "ShadowMapping::ShadowPass", 0xff4cc9f0u );
			...
			{
				LIGHTD3D12_CMD_SCOPE_NAMED( commandBuffer, "ShadowMapping::ShadowPreviewPass", 0xff90be6du );
			...
			{
				LIGHTD3D12_CMD_SCOPE_NAMED( commandBuffer, "ShadowMapping::ScenePass", 0xfff9c74fu );
			...
			if( app.imguiRenderer )
			{
				LIGHTD3D12_CMD_SCOPE_NAMED( commandBuffer, "ShadowMapping::ImguiPass", 0xfff9844au );
	...
	catch( const std::exception& exception )
	{
		...
		const std::string message = std::string( "LightD3D12 ShadowMapping failed:\n" ) + exception.what();
