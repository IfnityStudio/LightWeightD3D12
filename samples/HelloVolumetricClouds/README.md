...
- `samples/HelloVolumetricClouds/main.cpp`
...
- `samples/HelloVolumetricClouds/shaders/HelloVolumetricCloudsGroundVS.hlsl`
- `samples/HelloVolumetricClouds/shaders/HelloVolumetricCloudsGroundPS.hlsl`

These shaders render the imported plane from the original repo.

### Cloud shaders

- `samples/HelloVolumetricClouds/shaders/HelloVolumetricCloudsVS.hlsl`
- `samples/HelloVolumetricClouds/shaders/HelloVolumetricCloudsPS.hlsl`
...
- `samples/HelloVolumetricClouds/shaders/HelloVolumetricCloudsShapeNoiseCS.hlsl`
- `samples/HelloVolumetricClouds/shaders/HelloVolumetricCloudsDetailNoiseCS.hlsl`
...
- `HelloVolumetricClouds::GroundPass`
...
- `HelloVolumetricCloudsShapeNoiseCS.hlsl`
...
- `HelloVolumetricCloudsDetailNoiseCS.hlsl`
...
### In `HelloVolumetricCloudsPS.hlsl`
