...
namespace
{
	...
	LoadedModel CreateDuckModel( RenderDevice& ctx )
	{
		...
		vertexBufferDesc.debugName = "MeshDeformation Vertex Buffer";
		...
		indexBufferDesc.debugName = "MeshDeformation Index Buffer";
	...
	RenderPipelineState CreateDuckPipeline( RenderDevice& ctx, DXGI_FORMAT colorFormat, DXGI_FORMAT depthFormat, bool wireframe )
	{
		...
		desc.vertexShader = LightHLSLLoader::LoadStage( "shaders/MeshDeformationVS.hlsl", "vs_6_6" );
		desc.fragmentShader = LightHLSLLoader::LoadStage( wireframe ? "shaders/MeshDeformationWireframePS.hlsl" : "shaders/MeshDeformationSolidPS.hlsl", "ps_6_6" );
	...
	void RecreateDepthTarget( AppState& app )
	{
		...
		depthDesc.debugName = "MeshDeformation Depth";
...
int WINAPI wWinMain( HINSTANCE instance, HINSTANCE, PWSTR, int showCommand )
{
	try
	{
		...
		windowClass.lpszClassName = L"LightD3D12MeshDeformationWindow";
	...
	{
		MessageBoxA( nullptr, exception.what(), "LightD3D12 Mesh Deformation", MB_OK | MB_ICONERROR );
		return 1;
	}
}
