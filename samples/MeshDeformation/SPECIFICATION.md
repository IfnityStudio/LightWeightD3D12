...
- [main.cpp](/C:/LightWeightD3D12/samples/MeshDeformation/main.cpp)
- [MeshDeformationVS.hlsl](/C:/LightWeightD3D12/samples/MeshDeformation/shaders/MeshDeformationVS.hlsl)
- [MeshDeformationSolidPS.hlsl](/C:/LightWeightD3D12/samples/MeshDeformation/shaders/MeshDeformationSolidPS.hlsl)
...
- You can verify that in [main.cpp](/C:/LightWeightD3D12/samples/MeshDeformation/main.cpp), where the mesh center is subtracted from every imported vertex during normalization.
