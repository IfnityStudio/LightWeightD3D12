...
float4 main() : SV_Target0
{
	...
	void RecreateDepthTarget( AppState& app )
	{
		...
		depthDesc.debugName = "Instancing Depth";
	...
	void RebuildInstanceBuffer( AppState& app )
	{
		...
		instanceBufferDesc.debugName = "Instancing Instances";
...
int WINAPI wWinMain( HINSTANCE instance, HINSTANCE, PWSTR, int showCommand )
{
	try
	{
		...
		windowClass.lpszClassName = L"LightD3D12InstancingWindow";
