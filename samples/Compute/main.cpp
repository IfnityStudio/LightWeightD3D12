    ...
    uint groupIndex : SV_GroupIndex)
{
	...
	void RecordComputePass( ICommandBuffer& commandBuffer, AppState& app )
	{
		...
		LIGHTD3D12_CMD_SCOPE_NAMED( commandBuffer, "Compute::RecordComputePass", 0xff4cc9f0u );
	...
	{
		LIGHTD3D12_CMD_SCOPE_NAMED( commandBuffer, "Compute::RecordImguiPass", 0xfff9c74fu );
...
int WINAPI wWinMain( HINSTANCE instance, HINSTANCE, PWSTR, int showCommand )
{
	try
	{
		...
		windowClass.lpszClassName = L"LightD3D12ComputeWindow";
	...
	{
		MessageBoxA( nullptr, "LightD3D12 Compute failed.", "LightD3D12", MB_ICONERROR | MB_OK );
		return 1;
	}
}
