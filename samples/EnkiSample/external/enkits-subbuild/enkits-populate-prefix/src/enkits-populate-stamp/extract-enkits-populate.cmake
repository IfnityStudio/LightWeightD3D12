...
#
get_filename_component(filename "C:/LightWeightD3D12/samples/EnkiSample/external/enkits-subbuild/enkits-populate-prefix/src/03e6a2c0c97208ade44478d617d2002b0f95faf4.zip" ABSOLUTE)
get_filename_component(directory "C:/LightWeightD3D12/samples/EnkiSample/external/enkits-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-enkits-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-enkits-populate${i}")
